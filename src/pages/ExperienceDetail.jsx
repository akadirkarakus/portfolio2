...
export default function ExperienceDetail() {
  ...
  const { prev, next } = getSurroundingProjects(id);
    ...
    <div className="pt-32 pb-24 px-8 max-w-7xl mx-auto">
      ...
      <header className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-end mb-24">
        <div className="lg:col-span-8">
          <div className="inline-flex items-center gap-3 px-3 py-1.5 border border-outline-variant/30 bg-surface-container-highest/10 backdrop-blur-md rounded-md mb-6 text-[10px] text-on-surface-variant font-mono uppercase tracking-[0.2em]">
        ...
        <div className="lg:col-span-4 flex flex-col gap-8">
          <div className="p-8 bg-surface-container-highest/10 backdrop-blur-md border border-outline-variant/30 rounded-xl relative shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
            {/* Draft Corners */}
            <div className="absolute top-0 left-0 w-3 h-3 border-t border-l border-primary/40 rounded-tl-xl"></div>
            <div className="absolute top-0 right-0 w-3 h-3 border-t border-r border-primary/40 rounded-tr-xl"></div>
            <div className="absolute bottom-0 left-0 w-3 h-3 border-b border-l border-primary/40 rounded-bl-xl"></div>
            <div className="absolute bottom-0 right-0 w-3 h-3 border-b border-r border-primary/40 rounded-br-xl"></div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-6 mb-24">
        {/* Large Focus Image */}
        <div className="md:col-span-2 md:row-span-2 overflow-hidden rounded-xl border border-outline-variant/30 bg-surface-container-highest/10 p-2 relative group/img shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
        ...
        {/* Tech Stack Card */}
        <div className="md:col-span-2 p-10 bg-surface-container-highest/10 backdrop-blur-md border border-outline-variant/30 rounded-xl flex flex-col justify-between relative shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
          <div className="absolute top-0 right-0 w-6 h-6 border-t font-mono text-[8px] text-outline flex items-center justify-center p-2 border-l border-outline-variant/30 rounded-bl-xl">ID-01</div>
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {project.tags.map(tag => (
                <span key={tag} className="border border-outline-variant/30 text-on-surface-variant text-[9px] px-2.5 py-1 font-mono uppercase tracking-[0.15em] rounded-md bg-transparent">{tag}</span>
              ))}
            </div>
          </div>
        ...
        {/* Strategy Card */}
        <div className="p-8 bg-surface-container-highest/10 backdrop-blur-md rounded-xl flex flex-col justify-between border border-outline-variant/30 group hover:border-primary/50 transition-colors">
        ...
        {/* Visual Card */}
        <div className="p-8 bg-surface-container-highest/10 backdrop-blur-md rounded-xl flex flex-col justify-between border border-outline-variant/30">
      ...
      <section className="max-w-4xl mx-auto mb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div className="p-6 bg-surface-container-highest/10 backdrop-blur-md border border-outline-variant/30 rounded-xl relative group">
                <div className="absolute left-0 top-0 w-1 h-full bg-primary/50 rounded-l-xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
      ...
      <section className="mb-24">
        <div className="relative h-[614px] rounded-xl overflow-hidden group border border-outline-variant/30 p-2 bg-surface-container-highest/10 backdrop-blur-md shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
             {/* Draft Marks */}
      ...
      <section className="bg-surface-container-highest/10 backdrop-blur-md border border-outline-variant/30 rounded-xl p-16 text-center mb-16 relative shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
        {/* Draft Corners */}
        <div className="absolute top-0 left-0 w-4 h-4 border-t border-l border-outline-variant/50 rounded-tl-xl"></div>
        <div className="absolute top-0 right-0 w-4 h-4 border-t border-r border-outline-variant/50 rounded-tr-xl"></div>
        <div className="absolute bottom-0 left-0 w-4 h-4 border-b border-l border-outline-variant/50 rounded-bl-xl"></div>
        <div className="absolute bottom-0 right-0 w-4 h-4 border-b border-r border-outline-variant/50 rounded-br-xl"></div>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center">
          <button className="bg-primary/10 border border-primary text-primary px-8 py-4 rounded-full font-mono text-xs tracking-widest uppercase hover:bg-primary hover:text-on-primary transition-colors">Inspect System</button>
          <button className="bg-transparent text-on-surface border border-outline-variant/40 px-8 py-4 rounded-full font-mono text-xs tracking-widest uppercase hover:border-primary transition-colors">Case Study PDF</button>
        </div>
      </section>
      ...
      <div className="border-t border-outline-variant/30 pt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
        {prev ? (
          <Link to={`/experience/${prev.id}`} className="group flex flex-col items-start gap-4 p-8 rounded-xl bg-surface-container-highest/5 hover:bg-surface-container-highest/10 backdrop-blur-sm transition-all border border-transparent hover:border-outline-variant/30">
        ...
        {next && (
          <Link to={`/experience/${next.id}`} className="group flex flex-col items-end gap-4 p-8 rounded-xl bg-surface-container-highest/5 hover:bg-surface-container-highest/10 backdrop-blur-sm transition-all border border-transparent hover:border-outline-variant/30 text-right">
